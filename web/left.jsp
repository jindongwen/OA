    ...
    <dl class="leftmenu">
        <dd>
            ...
            <ul class="menuson">
                ...
                <li><cite></cite><a href="sxt/AddDeptnoServlet?method=deptFindAll" target="rightFrame">部门管理</a><i></i>
                </li>
                <li><cite></cite><a href="positionAdd.html" target="rightFrame">添加岗位</a><i></i></li>
                <li><cite></cite><a href="PosServlet?method=posSelectAll" target="rightFrame">岗位管理</a><i></i></li>
                <li><cite></cite><a href="sxt/EmployeeServlet?method=empFindDEM" target="rightFrame">添加员工</a><i></i>
                </li>
                <li><cite></cite><a href="sxt/EmployeeServlet?method=empFindAll" target="rightFrame">员工管理</a><i></i>
                </li>
            </ul>
        </dd>
        <dd>
